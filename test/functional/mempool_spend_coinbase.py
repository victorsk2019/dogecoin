...
but less mature coinbase spends are NOT.
"""
>>>>>>> 1.21-dev:test/functional/mempool_spend_coinbase.py
...
=======
        ...
        coinbase_txids = [self.nodes[0].getblock(h)['tx'][0] for h in b]
        spends_raw = [create_raw_transaction(self.nodes[0], txid, node0_address, amount=499999.99) for txid in coinbase_txids]
>>>>>>> 1.21-dev:test/functional/mempool_spend_coinbase.py
